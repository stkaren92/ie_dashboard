...
format: 
  pdf:
    include-in-header: header_cosmos.tex
    pdf-engine: xelatex
...
params:
  ...
  project_name: "cosmos" # cosmos or other
...
if(project_name == "cosmos"){
  df_cosmos_anps <- read.csv(paste0(rproject_path,"/data/anp_cosmos/cosmos_anps.csv"))
} else(
    df_cosmos_anps <- read.csv(paste0(rproject_path,'/data/anp_sym/sym_anps.csv'))
)
