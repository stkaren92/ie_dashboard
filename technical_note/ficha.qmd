...
anp_shp <- vect('/Users/kasanchez/Documents/ie_dashboard/data/anp/232_ANP-ITRF08_04072025.shp')

# Update Cienegas de Lerma shapefile
lerma_shp <- vect('/Users/kasanchez/Documents/ie_dashboard/data/anp/cienegas_lerma/Subzon_CLerma_utmitrf08_DOFPM.shp')
...
if(project_name == "cosmos"){
  df_cosmos_anps <- read.csv('/Users/kasanchez/Documents/ie_dashboard/data/anp_cosmos/cosmos_anps.csv')
    ...
    df_cosmos_anps <- read.csv('/Users/kasanchez/Documents/ie_dashboard/data/anp_sym/sym_anps.csv')
)
